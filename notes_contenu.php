...
// Récupérer les notes associées au contenu sélectionné
$sql = "SELECT * FROM Note WHERE ID_Contenu = :contenu_id AND ID_Utilisateur = :user_id";
$stmt = $pdo->prepare($sql);
$stmt->execute(['contenu_id' => $contenu_id, 'user_id' => $user_id]);
$notes = $stmt->fetchAll();
?>
...
<head>
    ...
    <title>Notes pour le contenu</title>
    <!-- Bulma CSS -->
...
<body>
    <div class="columns">
        <div class="column is-three-quarters content">
            <h1 class="title">Notes sur le Contenu</h1>
            <div class="content">
